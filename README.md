...
O script se resume a uma simples função python que recebe um nome brasileiro e retorna "F" se o nome for feminino e "M" se o nome for masculino. Ele faz isso por meio do consumo da API:https://brasil.io/dataset/genero-nomes/nomes/ através do pacote requests por isso é necessário instalá-lo. A própria API retorna qual gênero mais registrou o nome solicitado. 
